...
if (counter>t1) {
  ...
  get(`${mn}${ngay}.html`).then($ => {
   ...
   let r={
    ...
    kqmn:{
      ...
      21:{
        ...
        1:a1.substr(45,5),
        2:a2.substr(44,5),
        3:[a3.substr(58,5),a3.substr(63,5)],
        4:[a4.substr(133,5),a4.substr(138,5),a4.substr(143,5),a4.substr(148,5),a4.substr(153,5),a4.substr(158,5),a4.substr(163,5)],
        5:a5.substr(41,4),
        6:[a6.substr(65,4),a6.substr(69,4),a6.substr(73,4)],
        7:a7.substr(38,3),
        8:a8.substr(35,2),
      }
    },
    kqmt:{
      ...
      38:{
        ...
        1:b1.substr(35,5),
        2:b2.substr(34,5),
        3:[b3.substr(43,5),b3.substr(48,5)],
        4:[b4.substr(93,5),b4.substr(98,5),b4.substr(103,5),b4.substr(108,5),b4.substr(113,5),b4.substr(118,5),b4.substr(123,5)],
        5:b5.substr(32,4),
        6:[b6.substr(48,4),b6.substr(52,4),b6.substr(56,4)],
        7:b7.substr(30,3),
        8:b8.substr(28,2),
      }
    },
   ...
   db.create(r,(e,re)=>{if(e) console.log('e thu7');})
  })
})
})
  counter += 86400000*7;
